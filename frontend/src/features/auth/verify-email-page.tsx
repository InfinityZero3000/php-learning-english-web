...
export function VerifyEmailPage() {
  ...
  async function resend() { setError(""); setSending(true); try { setSuccess((await auth.resendVerification()).message); } catch (cause) { setError(cause instanceof ApiError ? cause.message : "Không thể gửi lại email."); } finally { setSending(false); } }
